...
class handDetector():
    def __init__(self, mode=False, maxHands=2, detectionCon=0.5, trackCon=0.5):
        ...
        """ note: perbaikan error: nama parameter di dalam self.hands (kode di atas) harus diganti nama-nama seperti static_image_mode, max_num_hands, min_detection_confidence, dan min_tracking_confidence """
